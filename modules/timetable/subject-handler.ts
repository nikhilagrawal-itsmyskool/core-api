...
export const list = guard(TIMETABLE_ACTIONS['subject-handler.list'], handler.list);
export const getById = guard(TIMETABLE_ACTIONS['subject-handler.getById'], handler.getById);
export const create = guard(TIMETABLE_ACTIONS['subject-handler.create'], handler.create);
export const update = guard(TIMETABLE_ACTIONS['subject-handler.update'], handler.update);
export const remove = guard(TIMETABLE_ACTIONS['subject-handler.remove'], handler.remove);
